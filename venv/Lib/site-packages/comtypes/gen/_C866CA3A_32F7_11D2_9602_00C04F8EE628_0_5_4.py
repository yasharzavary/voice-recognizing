...
__all__ = [
    'SPVPRI_NORMAL', 'SpeechPartOfSpeech', 'SpeechTokenContext',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPWT_DISPLAY',
    'DISPID_SOTGetAttribute', 'ISpeechAudioBufferInfo',
    'SpeechFormatType', 'SVEAudioLevel', 'SpeechRecognizerState',
    'DISPID_SRCESoundEnd', 'DISPID_SMSALineId',
    'DISPID_SPPFirstElement', 'ISpeechPhraseProperty',
    'SGLexicalNoSpecialChars', 'SSTTDictation', 'SpObjectToken',
    'DISPID_SGRSTRule', 'DISPID_SVVoice', 'DISPID_SPRulesCount',
    'eLEXTYPE_PRIVATE1', 'ISpeechGrammarRuleStateTransition',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SWFEBitsPerSample', 'STCRemoteServer',
    'DISPID_SWFEFormatTag', 'SPPARTOFSPEECH',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRSAudioStatus', 'SASRun',
    'DISPID_SPACommit', 'ISpRecoContext2', 'SREInterference',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpXMLRecoResult',
    'SREStateChange', 'ISpeechXMLRecoResult',
    'SPEI_START_INPUT_STREAM', 'SECFIgnoreCase',
    'SpeechRecognitionType', 'DISPID_SOTDisplayUI', 'SP_VISEME_9',
    'SREAllEvents', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechAudioStatus', 'DISPID_SGRsFindRule',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGCmdLoadFromMemory',
    'SVSFlagsAsync', 'SVP_19', 'DISPID_SMSSetData',
    'ISpeechPhraseAlternate', 'DISPID_SpeechLexiconWord',
    'DISPID_SPRulesItem', 'SAFT8kHz8BitStereo', 'DISPID_SRGId',
    'DISPID_SRSetPropertyString', 'SpAudioFormat', 'SVP_2',
    'SAFT11kHz8BitStereo', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRGetFormat', 'SpeechAllElements', 'SPPROPERTYINFO',
    'SREFalseRecognition', 'ISpeechPhraseReplacements', 'SP_VISEME_7',
    'DISPID_SpeechLexicon', 'SPGS_ENABLED', 'SpPhraseInfoBuilder',
    'SpeechCategoryRecognizers', 'SpeechRuleAttributes',
    'ISpStreamFormatConverter', 'DISPID_SpeechPhraseProperties',
    'SPFM_OPEN_READONLY', 'DISPID_SRRTimes', 'SVP_17',
    'SPPS_RESERVED1', 'SPRST_INACTIVE_WITH_PURGE',
    'eWORDTYPE_DELETED', 'SVSFParseMask', 'DISPID_SPRuleFirstElement',
    'DISPID_SCSBaseStream', 'SRERequestUI', 'DISPID_SpeechBaseStream',
    'SpeechGrammarTagDictation', 'DISPID_SpeechRecoContext',
    'SAFTADPCM_44kHzStereo', 'IEnumSpObjectTokens',
    'SVEStartInputStream', 'SpStream', 'SpeechGrammarWordType',
    'SVEPhoneme', 'DISPID_SPIEngineId', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPWORDPRONUNCIATION', 'DISPID_SPAPhraseInfo',
    'DISPID_SVDisplayUI', 'DISPID_SRGSetWordSequenceData', 'SLTApp',
    'SITooLoud', 'SAFTText', 'SPSTREAMFORMATTYPE',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_6', 'SP_VISEME_4',
    'SPEI_VOICE_CHANGE', 'DISPID_SVAudioOutputStream',
    'DISPID_SPEDisplayText', 'UINT_PTR', 'DISPID_SLGetPronunciations',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_PRIVATE13',
    'SPCT_DICTATION', 'DISPID_SLWs_NewEnum', 'SVP_8', 'SPSMF_UPS',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRGetRecognizers',
    'tagSPTEXTSELECTIONINFO', 'SPVPRIORITY', 'DISPID_SRDisplayUI',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SDKSetBinaryValue', 'ISpEventSource', 'SPWAVEFORMATTYPE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEVENT', 'SAFT11kHz16BitMono',
    'SPBO_TIME_UNITS', 'SPRST_ACTIVE_ALWAYS', 'SPAR_Unknown',
    'SDKLLocalMachine', 'SVP_7', 'ISpeechWaveFormatEx',
    'SpTextSelectionInformation', 'ISpRecoContext', 'ISpRecognizer2',
    'DISPID_SPRNumberOfElements', 'DISPID_SVStatus',
    'eLEXTYPE_RESERVED10', 'DISPID_SpeechCustomStream',
    'SpeechAudioState', 'SpCustomStream', 'SpeechVoiceEvents',
    'DISPID_SRRRecoContext', 'SpeechAudioFormatType',
    'DISPID_SGRSAddWordTransition', 'SPSHT_NotOverriden',
    'SVSFIsNotXML', 'SpeechRunState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVEEnginePrivate', 'SVEEndInputStream',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechPhraseInfo', 'STSF_CommonAppData',
    'SAFT12kHz8BitMono', 'SpeechTokenKeyFiles',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechRecoGrammar',
    'SPLEXICONTYPE', 'ISpeechPhraseInfo', 'SREAudioLevel',
    'DISPID_SOTGetStorageFileName', 'SPEI_SOUND_END',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVEAllEvents',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechRecoResult2', 'SPSFunction',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SGRAddResource',
    'SDTReplacement', 'SECNormalConfidence', 'SITooQuiet',
    'SAFT32kHz8BitStereo', 'SPLOADOPTIONS', 'SpResourceManager',
    'SPPS_NotOverriden', 'SPSInterjection', 'SPFM_CREATE',
    'DISPID_SPIRule', 'SVSFVoiceMask', 'eLEXTYPE_RESERVED4',
    'SpeechDataKeyLocation', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPPParent',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechMemoryStream',
    'SPEI_MAX_TTS', 'ISpeechPhraseRules', 'SDTAudio',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVP_9',
    'DISPID_SPEAudioStreamOffset', 'SAFT24kHz8BitStereo',
    'SVF_Emphasis', 'DISPID_SRStatus', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPIStartTime', 'SPDKL_LocalMachine',
    'ISpeechPhoneConverter', 'DISPID_SPRs_NewEnum', 'LONG_PTR',
    'ISpObjectTokenCategory', 'SAFT16kHz8BitMono',
    'SAFT16kHz16BitMono', 'ISpeechVoiceStatus',
    'DISPID_SVGetAudioInputs', '_ISpeechVoiceEvents',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRCEEndStream',
    'DISPID_SPCPhoneToId', 'SpNotifyTranslator',
    'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE3',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SRADefaultToActive',
    'SRADynamic', 'SpeechAudioProperties', 'SpeechWordType',
    'DISPID_SLWsCount', 'ISpeechPhraseReplacement',
    'SVSFNLPSpeakPunc', 'SREAdaptation', 'SVSFPurgeBeforeSpeak',
    'ISpeechLexiconWords', 'SPEI_RECO_OTHER_CONTEXT', 'SPFILEMODE',
    'DISPID_SLWLangId', 'SPVOICESTATUS', 'SPSHT_OTHER',
    'DISPID_SRGReset', 'SVSFUnusedFlags',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_PRIVATE14',
    'SAFT44kHz8BitStereo', 'SPGS_DISABLED', 'SPAS_CLOSED',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechGrammarRule', 'DISPID_SPIGetText',
    'SAFTADPCM_8kHzStereo', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SGRSTNextState', 'SRSActive', 'SDKLDefaultLocation',
    'ISpShortcut', 'DISPID_SVGetAudioOutputs',
    'SREPropertyStringChange', 'DISPID_SOTIsUISupported',
    'DISPID_SRCESoundStart', 'SPWORD', 'SGLexical', 'SVP_4',
    'SPSEMANTICFORMAT', 'SP_VISEME_20', 'DISPID_SGRSTType',
    'DISPID_SDKGetStringValue', 'SPSNoun', 'SREBookmark',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechCategoryPhoneConverters',
    'DISPID_SRRTTickCount', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SpeechPhraseAlternate', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechObjectToken', 'DISPID_SRState', 'ISpeechAudio',
    'SVEBookmark', 'SAFT12kHz16BitStereo', 'SBOPause',
    'SpMMAudioEnum', 'SWTDeleted', 'DISPID_SVEPhoneme',
    'eWORDTYPE_ADDED', 'SGRSTTEpsilon', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEI_RESERVED1', '__MIDL_IWinTypes_0009', 'SPSModifier',
    'ISpGrammarBuilder', 'ISpeechAudioFormat', 'DISPID_SPRuleParent',
    'DISPID_SDKEnumKeys', 'ISpeechCustomStream', 'DISPID_SGRSTsItem',
    'SDKLCurrentUser', 'SPWORDLIST', 'eLEXTYPE_VENDORLEXICON',
    'SRESoundStart', 'SpeechDiscardType',
    'ISpeechObjectTokenCategory', 'SAFTNonStandardFormat',
    'DISPID_SGRs_NewEnum', 'SP_VISEME_19', 'DISPID_SRRTLength',
    'SpeechAudioVolume', 'tagSPPROPERTYINFO', 'ISpeechObjectTokens',
    'STSF_AppData', 'SFTSREngine', 'ISpeechResourceLoader',
    'SRCS_Enabled', 'DISPID_SpeechFileStream', 'DISPID_SVSkip',
    'SPEI_MIN_SR', 'Speech_Max_Pron_Length', 'SAFT32kHz16BitStereo',
    'DISPID_SABIEventBias', 'DISPID_SLWWord', 'SAFT24kHz16BitStereo',
    'DISPID_SPEActualConfidence', 'DISPID_SpeechRecoResultTimes',
    'SVEPrivate', 'DISPIDSPTSI_SelectionOffset', 'SPSERIALIZEDRESULT',
    'ISpObjectToken', 'SPSNotOverriden', 'SPWORDTYPE',
    'DISPID_SASCurrentSeekPosition', 'SSTTWildcard',
    'SpNullPhoneConverter', 'DISPID_SRCEEnginePrivate',
    'eLEXTYPE_PRIVATE7', 'SAFT22kHz8BitStereo', 'SREPhraseStart',
    'SPEI_RESERVED5', 'DISPID_SVEBookmark', 'DISPID_SWFEChannels',
    'DISPID_SMSGetData', 'SpeechLexiconType', 'SPEI_PHRASE_START',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRRAudioFormat',
    'ISpeechObjectToken', 'SpeechEngineConfidence', 'SVSFIsFilename',
    'SVSFIsXML', 'eLEXTYPE_MORPHOLOGY', 'ISpeechPhraseElement',
    'SP_VISEME_5', 'DISPID_SVWaitUntilDone', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPIAudioSizeBytes', 'SPPHRASEPROPERTY',
    'DISPID_SpeechPhoneConverter', 'DISPID_SGRsCount',
    'DISPID_SRGDictationUnload', 'SPRECOSTATE', 'ISpNotifySource',
    'SpeechPropertyResponseSpeed', 'SECFEmulateResult',
    'DISPID_SRCVoicePurgeEvent', 'SAFT44kHz16BitStereo', 'SLTUser',
    'DISPID_SRIsShared', 'SPXRO_Alternates_SML',
    'SpeechGrammarTagWildcard', 'DISPID_SPEEngineConfidence',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPPId',
    'SDTDisplayText', 'ISpRecognizer', 'SPEI_END_SR_STREAM',
    'SPAUDIOOPTIONS', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SRARoot', 'SGRSTTTextBuffer', 'DISPID_SVEVoiceChange',
    'ISpRecoGrammar2', 'SAFTGSM610_8kHzMono',
    'DISPID_SWFESamplesPerSec', 'DISPID_SOTRemove',
    'DISPID_SVEStreamStart', 'SPCT_SLEEP', 'eLEXTYPE_PRIVATE15',
    'ISpeechGrammarRuleState', 'DISPID_SpeechGrammarRules',
    'eLEXTYPE_PRIVATE6', 'ISpStream', 'DISPID_SRCCreateGrammar',
    'SVF_None', 'SVPNormal', 'DISPID_SPRuleChildren',
    'DISPID_SPRuleEngineConfidence', 'SWTAdded',
    'DISPID_SVSInputSentenceLength', 'SP_VISEME_2', 'ISpAudio',
    'SP_VISEME_21', 'SpeechStreamFileMode',
    'DISPID_SpeechVoiceStatus', 'SPEI_RESERVED2',
    'SpeechAudioFormatGUIDText', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT16kHz16BitStereo', 'DISPID_SPAsItem',
    'DISPID_SOTGetDescription', 'DISPID_SLPLangId',
    'DISPID_SPEs_NewEnum', 'SBONone',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SLPType', 'SPAR_Low',
    'SECFNoSpecialChars', 'DISPID_SFSClose',
    'SpeechDisplayAttributes', 'SAFTGSM610_44kHzMono', 'SPAR_Medium',
    'SPAO_RETAIN_AUDIO', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVSInputWordPosition', 'SP_VISEME_13', 'SGPronounciation',
    'DISPID_SPPEngineConfidence', 'ISpeechRecoResultDispatch',
    'ISpeechDataKey', 'SpInProcRecoContext', 'DISPID_SPRuleId',
    'SPEI_SR_BOOKMARK', 'SPAR_High', 'DISPID_SRCBookmark',
    'DISPID_SVGetVoices', 'SVF_Stressed', 'eLEXTYPE_PRIVATE19',
    'SpeechCategoryVoices', 'ISpeechVoice', 'SAFT8kHz8BitMono',
    'SpeechEngineProperties', 'SpSharedRecognizer',
    'SpeechInterference', 'DISPID_SRCEHypothesis',
    'SVESentenceBoundary', 'SVP_21', 'WAVEFORMATEX',
    'eLEXTYPE_PRIVATE11', 'SPEI_SOUND_START',
    'SGDSActiveWithAutoPause', 'SVPOver', 'ISpeechLexicon',
    'ISpNotifyTranslator', 'tagSTATSTG',
    'SpeechVoiceSkipTypeSentence', 'SAFT12kHz8BitStereo',
    'DISPID_SVSCurrentStreamNumber', 'ISpVoice',
    'eLEXTYPE_LETTERTOSOUND', 'ISpObjectWithToken',
    'DISPID_SPISaveToMemory', 'SPEI_ADAPTATION', 'SPPS_SuppressWord',
    'STSF_FlagCreate', 'DISPID_SPCIdToPhone', 'SPXRO_SML',
    'eLEXTYPE_PRIVATE20', 'SPSHT_EMAIL', 'SpeechTokenValueCLSID',
    'SPPS_Verb', 'Speech_Max_Word_Length', 'SAFTGSM610_11kHzMono',
    'SECFDefault', 'SPSVerb', 'ISpeechGrammarRule',
    'DISPID_SRCRecognizer',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechUserTraining', 'SSTTTextBuffer', 'SPADAPTATIONRELEVANCE',
    'SP_VISEME_16', 'DISPID_SVAlertBoundary', 'SPINTERFERENCE_NONE',
    'DISPID_SVIsUISupported', 'DISPID_SLGenerationId',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCEInterference',
    'SAFT11kHz16BitStereo', 'SPWT_LEXICAL', 'SpeechRuleState',
    'ISpeechRecoResult2', 'DISPID_SpeechRecoContextEvents',
    'ISpDataKey', 'DISPID_SPARecoResult', 'SPAS_STOP', 'SASClosed',
    'DISPID_SRRPhraseInfo', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRProfile', 'DISPID_SMSAMMHandle',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVP_18', 'DISPID_SRRAlternates',
    'SPEI_RECOGNITION', 'SVP_10', 'DISPID_SFSOpen',
    'eLEXTYPE_RESERVED9', 'STCLocalServer', 'ISequentialStream',
    'SREStreamStart', 'Speech_Default_Weight',
    'DISPID_SPIEnginePrivateData', 'SPLO_DYNAMIC', 'SPPS_Unknown',
    'SPGS_EXCLUSIVE', 'DISPID_SMSADeviceId', 'ISpeechLexiconWord',
    'SINone', 'SPFM_OPEN_READWRITE', 'DISPID_SWFEAvgBytesPerSec',
    'SDA_One_Trailing_Space', 'SPDKL_DefaultLocation',
    'DISPID_SVSpeakCompleteEvent', 'SPSHT_Unknown',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCERequestUI', 'SPAS_RUN',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRSTsCount',
    'DISPIDSPTSI_ActiveLength', 'SDTRule', 'SECFIgnoreKanaType',
    'SRAInterpreter', 'SPFM_NUM_MODES', 'SpeechVoicePriority',
    'DISPID_SABIMinNotification', 'SGDisplay',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRName',
    'SpeechTokenKeyAttributes', 'SGRSTTDictation',
    'SAFT8kHz16BitStereo', 'DISPID_SPRDisplayAttributes', 'SRTReSent',
    'DISPID_SPRsItem', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRuleNumberOfElements', 'SPCS_ENABLED',
    'DISPID_SOTCategory', 'SpPhoneticAlphabetConverter',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVESentenceBoundary', 'SPGRAMMARWORDTYPE', 'SP_VISEME_12',
    'ISpRecoCategory', 'eLEXTYPE_USER_SHORTCUT', 'SGRSTTRule',
    'DISPID_SRRAudio', 'DISPID_SRRDiscardResultInfo', 'SREHypothesis',
    'SpeechRecoProfileProperties', 'ISpeechLexiconPronunciation',
    'DISPID_SDKGetBinaryValue', 'DISPID_SLPPartOfSpeech',
    'DISPID_SDKDeleteValue', 'SPCT_COMMAND',
    'DISPID_SpeechRecoResult', 'SP_VISEME_15',
    'DISPID_SRGCmdSetRuleState', 'SRTExtendableParse',
    'SPSEMANTICERRORINFO', 'SPEI_VISEME', 'DISPID_SLWsItem',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVSLastBookmarkId',
    'STCInprocHandler', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechWordPronounceable', 'DISPID_SPAStartElementInResult',
    'DISPID_SPPsCount', 'DISPID_SBSSeek', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPRuleConfidence',
    'SpeechCategoryAudioOut', '_RemotableHandle', 'DISPID_SBSRead',
    'DISPID_SVEStreamEnd', 'SP_VISEME_14', 'SPSHORTCUTPAIR',
    'SAFT22kHz8BitMono', 'SPRULESTATE', 'SPWF_SRENGINE',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCResume', 'SGSExclusive',
    'DISPID_SPAsCount', 'SVSFParseSsml', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTADPCM_22kHzMono', 'ISpeechBaseStream', 'ISpeechMMSysAudio',
    'SREStreamEnd', 'SASPause', 'DISPID_SDKDeleteKey', 'SVP_3',
    'SpCompressedLexicon', 'SRTAutopause', 'SAFT44kHz8BitMono',
    'ISpeechRecoResult', 'SPEI_TTS_BOOKMARK',
    'SpeechAudioFormatGUIDWave', 'SPINTERFERENCE_TOOQUIET',
    'SGSEnabled', 'DISPID_SPILanguageId', 'SpWaveFormatEx',
    'DISPID_SLRemovePronunciation', 'SPEI_HYPOTHESIS',
    'SVEWordBoundary', 'SPAO_NONE', 'DISPID_SLAddPronunciation',
    'ISpeechRecognizerStatus', 'SpUnCompressedLexicon',
    'DISPID_SDKSetStringValue', 'SDTLexicalForm', 'SVP_11',
    'SLODynamic', 'DISPID_SPRText', 'DISPID_SPPValue', 'SRATopLevel',
    'SPPS_RESERVED2', 'DISPID_SPIReplacements', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVResume', 'ISpRecognizer3', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRCPause', 'SpFileStream', 'SSFMOpenReadWrite',
    'SAFTNoAssignedFormat', 'DISPID_SRCEFalseRecognition',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVSpeakStream', 'SpInprocRecognizer',
    'SVP_12', 'SDA_No_Trailing_Space', 'ISpStreamFormat',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPIElements',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SpeechAudio',
    'SVP_14', 'SRSInactive', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPEsCount', 'SP_VISEME_8', 'DISPID_SASNonBlockingIO',
    'DISPID_SOTCGetDataKey', 'SPPHRASEELEMENT',
    'DISPID_SpeechPhraseRules', 'ISpSerializeState', 'STCAll',
    'DISPID_SGRSTPropertyValue', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT48kHz8BitMono',
    'SSFMOpenForRead', 'SPAUDIOSTATUS', 'DISPID_SRCCmdMaxAlternates',
    'SPEI_SR_PRIVATE', 'DISPID_SRCEventInterests', 'DISPID_SLPsCount',
    'SREPrivate', 'DISPID_SVVolume', 'DISPID_SRGState',
    'DISPID_SDKGetlongValue', 'SPPS_Interjection',
    'ISpeechRecoContext', 'SGDSInactive', 'eLEXTYPE_PRIVATE8',
    'SpeechRecoEvents', 'SpeechEmulationCompareFlags',
    'DISPID_SPIProperties', 'DISPID_SGRsItem', 'DISPID_SRRecognizer',
    'DISPID_SRGSetTextSelection', 'DISPID_SOTDataKey',
    'SpeechBookmarkOptions', 'DISPID_SOTsCount',
    'ISpeechRecoResultTimes', 'SpeechRegistryLocalMachineRoot',
    'SpMMAudioIn', 'DISPID_SPEPronunciation', 'SVP_13', 'SPPHRASE',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRRSpeakAudio',
    'SPXMLRESULTOPTIONS', 'DISPID_SPELexicalForm',
    'DISPID_SGRsCommitAndSave', 'SpMMAudioOut', 'SPDKL_CurrentUser',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechAudioStatus',
    'DISPID_SWFEBlockAlign', 'SPEI_PHONEME', 'SRAExport',
    'SPPHRASEREPLACEMENT', 'SPWF_INPUT', 'SDTAll',
    'DISPID_SRGDictationLoad', 'SVEVoiceChange',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPCT_SUB_DICTATION',
    'DISPID_SRRGetXMLResult', 'SP_VISEME_17', 'DISPID_SVGetProfiles',
    'ISpPhoneConverter', 'DISPID_SPRsCount',
    'DISPID_SPPNumberOfElements', 'SpVoice', 'DISPID_SVSLastResult',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SAStatus', 'SPEVENTENUM',
    'eLEXTYPE_PRIVATE9', 'SAFT24kHz8BitMono', 'SP_VISEME_11',
    'DISPID_SRCRequestedUIType', 'SPBO_AHEAD', 'SpShortcut',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechDictationTopicSpelling',
    'DISPID_SWFEExtraData', 'SpeechVoiceSpeakFlags',
    'DISPID_SRGCommit', 'SGDSActive', 'DISPID_SGRInitialState',
    'SpeechRetainedAudioOptions', 'DISPID_SVSpeak',
    'SPWT_PRONUNCIATION', '_ISpeechRecoContextEvents',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPPName', 'DISPID_SAFGuid',
    'DISPID_SLWPronunciations', 'DISPID_SDKEnumValues',
    'DISPID_SpeechPhraseReplacement', 'SVP_6',
    'DISPID_SASCurrentDevicePosition', 'SpeechStreamSeekPositionType',
    'SWPUnknownWordUnpronounceable', 'SpeechTokenShellFolder',
    'SPEVENTSOURCEINFO', 'ISpResourceManager', 'DISPIDSPRG',
    'DISPID_SGRsCommit', 'SpLexicon', 'ISpEventSink',
    'DISPID_SGRAttributes', 'ISpeechTextSelectionInformation',
    'DISPID_SVSPhonemeId', 'DISPID_SPPConfidence', 'SPRST_NUM_STATES',
    'DISPID_SRRTOffsetFromStart', 'SAFTADPCM_8kHzMono',
    'SPPS_Noncontent', 'SPBINARYGRAMMAR', 'SAFTCCITT_uLaw_8kHzStereo',
    ...
    'ISpeechGrammarRules', 'SVSFDefault', 'DISPID_SPCLangId',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRCEStartStream',
    'SVP_15', 'DISPID_SPPChildren', 'SVSFParseSapi', 'IStream',
    'SPTEXTSELECTIONINFO', 'SRERecoOtherContext',
    'DISPID_SPEDisplayAttributes', 'DISPID_SDKSetLongValue',
    'IEnumString', 'Speech_StreamPos_Asap',
    'DISPID_SPIGetDisplayAttributes', 'SECFIgnoreWidth',
    'ISpPhraseAlt', 'SECHighConfidence', 'DISPID_SPEsItem',
    'SVEViseme', 'SAFT24kHz16BitMono', 'DISPID_SVSLastBookmark',
    'SpeechPropertyResourceUsage', 'SPAS_PAUSE',
    'SPINTERFERENCE_NOISE', 'SITooFast', 'DISPID_SOTs_NewEnum',
    'DISPID_SAFSetWaveFormatEx', 'ISpeechMemoryStream',
    'SPPS_RESERVED3', 'DISPID_SPEAudioSizeTime',
    'SPEI_RECO_STATE_CHANGE', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SLGetWords', 'SSFMCreate',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SpeechRecognizer',
    'SGDSActiveUserDelimited', 'DISPID_SPPs_NewEnum',
    'SPINTERFERENCE_TOOSLOW', 'ISpLexicon', 'SPEI_WORD_BOUNDARY',
    'SPDATAKEYLOCATION', 'DISPID_SPERequiredConfidence',
    'SpeechVisemeFeature', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFT22kHz16BitMono', 'DISPID_SAFType', 'SPRS_INACTIVE',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SADefaultFormat',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_RESERVED7', 'SPPHRASERULE',
    'DISPID_SRCEAudioLevel', 'SLOStatic',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SBSWrite', 'SVP_5',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SLPPhoneIds',
    'SAFT48kHz16BitStereo', 'SREPropertyNumChange', 'SPPS_LMA',
    'SPBOOKMARKOPTIONS', 'SWPKnownWordPronounceable', 'SAFTDefault',
    'DISPID_SGRSTransitions', 'SAFTExtendedAudioFormat',
    'SP_VISEME_10', 'SPDKL_CurrentConfig', 'DISPID_SRIsUISupported',
    'ISpNotifySink', 'SAFT11kHz8BitMono', 'SPVPRI_OVER',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_RESERVED8',
    'SDTPronunciation', 'SPSSuppressWord', 'SPCS_DISABLED',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRsAdd',
    'SAFTGSM610_22kHzMono', 'DISPID_SPRules_NewEnum', 'SPLO_STATIC',
    'DISPID_SAVolume', 'ISpeechPhraseProperties', 'SPEI_RESERVED6',
    'SASStop', 'DISPID_SpeechWaveFormatEx', 'SVP_1',
    'ISpeechPhraseAlternates', 'SpeechSpecialTransitionType',
    'SINoSignal', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPIAudioStreamPosition', 'SRERecognition', 'SVP_16',
    'ISpeechPhraseInfoBuilder', 'DISPID_SABufferNotifySize',
    'DISPID_SGRSRule', 'SRTStandard', 'DISPID_SPRFirstElement',
    'DISPID_SpeechMMSysAudio', 'SpeechMicTraining',
    'SSSPTRelativeToEnd', 'SPRST_ACTIVE', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCreateRecoContext', 'DISPID_SRGDictationSetState',
    'SpSharedRecoContext', 'SPCT_SUB_COMMAND', 'SVSFParseAutodetect',
    'eLEXTYPE_APP', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPAs_NewEnum',
    'DISPID_SVPause', 'DISPID_SGRSAddSpecialTransition', 'SINoise',
    'SP_VISEME_0', 'DISPID_SpeechAudioBufferInfo', 'DISPID_SOTCId',
    'SPSUnknown', 'DISPID_SREmulateRecognition', 'DISPID_SGRsDynamic',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRCEPhraseStart',
    'SVSFNLPMask', 'SVSFPersistXML', 'STCInprocServer',
    'SP_VISEME_18', 'eLEXTYPE_USER', 'SAFT22kHz16BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPPsItem',
    'DISPID_SLPs_NewEnum', 'SpeechRegistryUserRoot',
    'SpeechLoadOption', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'IInternetSecurityMgrSite', 'DISPID_SpeechRecognizerStatus',
    'ISpRecoGrammar', 'SGSDisabled', 'SPEI_REQUEST_UI',
    'DISPID_SOTMatchesAttributes', 'SRAONone', 'DISPID_SOTCDefault',
    'SVPAlert', 'SAFT12kHz16BitMono', 'SpeechAddRemoveWord',
    'SGRSTTWord', 'DISPID_SpeechPhraseRule',
    'DISPID_SVSLastStreamNumberQueued', 'SP_VISEME_1',
    'DISPID_SVRate', 'DISPID_SABufferInfo', 'DISPID_SLPsItem',
    'ISpeechRecognizer', 'DISPID_SRGRecoContext',
    'Speech_StreamPos_RealTime', 'DISPID_SOTCSetId',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechAudioFormat', 'SPPS_Modifier', 'SPEI_TTS_PRIVATE',
    'DISPID_SAEventHandle', 'SRAImport', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTADPCM_44kHzMono', 'SVP_20', 'SpObjectTokenCategory',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE18', 'SRSInactiveWithPurge',
    ...
    'SAFT48kHz16BitMono', 'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE10',
    'DISPID_SpeechObjectTokens', 'DISPID_SAFGetWaveFormatEx',
    'STSF_LocalAppData', 'DISPID_SBSFormat', 'SpeechRecoContextState',
    'SSSPTRelativeToStart', 'SRAORetainAudio',
    'DISPID_SRCRetainedAudio', 'SRSEDone', 'DISPID_SVEWord',
    'DISPID_SpeechGrammarRuleState', 'SPRECORESULTTIMES',
    'SPINTERFERENCE', 'SPRST_INACTIVE', 'SPVISEMES', '_SPAUDIOSTATE',
    'SPEI_MAX_SR', 'SPPS_Function', 'SPRULE', 'DISPID_SGRSTText',
    'DISPID_SVEViseme', 'ISpPhrase', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRRTStreamTime', 'SpPhoneConverter', 'DISPID_SRGRules',
    'ISpRecoResult', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SGRId', 'DISPID_SVSRunningState', 'DISPID_SpeechDataKey',
    'SRTSMLTimeout', 'SAFT32kHz8BitMono', 'DISPID_SASState',
    'SpeechCategoryAudioIn', 'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE2',
    'SPEI_END_INPUT_STREAM', 'SITooSlow', 'SPWORDPRONOUNCEABLE',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SASetState',
    'SAFT44kHz16BitMono', 'SP_VISEME_3', 'DISPID_SABIBufferSize',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechPhraseElements',
    'SRSEIsSpeaking', 'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseRule',
    ...
    'SPCONTEXTSTATE', 'SDTAlternates', 'DISPID_SVSInputWordLength',
    'eLEXTYPE_PRIVATE16', 'SPEI_INTERFERENCE', 'SPCATEGORYTYPE',
    'DISPID_SRCEBookmark', 'SPBO_NONE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSLMA',
    'DISPID_SVAudioOutput', 'DISPID_SpeechPhraseElements',
    'SPRS_ACTIVE', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_START_SR_STREAM', 'SRCS_Disabled', 'SPEI_RESERVED3',
    'SECLowConfidence', 'SWPUnknownWordPronounceable',
    'SSFMCreateForWrite', 'ISpProperties',
    ...
    'DISPID_SRRSaveToMemory', 'DISPID_SRAudioInput',
    'SpeechGrammarTagUnlimitedDictation', 'SAFTCCITT_ALaw_8kHzMono',
    'SFTInput', 'DISPID_SRCERecognition', 'DISPID_SRCVoice', 'SVP_0',
    'SAFT32kHz16BitMono', 'SPRECOGNIZERSTATUS', 'SpeechTokenKeyUI',
    'SAFT8kHz16BitMono', 'SPGRAMMARSTATE', 'eLEXTYPE_RESERVED6',
    'DISPID_SPERetainedStreamOffset', 'SPBO_PAUSE',
    'DISPID_SRGetPropertyString', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCEAdaptation',
    'SAFTADPCM_11kHzStereo', 'SPEI_UNDEFINED', 'SRSActiveAlways',
    'DISPID_SGRClear', 'SpStreamFormatConverter',
    'DISPID_SRSSupportedLanguages', 'SpeechCategoryRecoProfiles',
    'SPPS_Noun', 'DISPID_SLPSymbolic', 'DISPID_SDKCreateKey',
    'SGRSTTWildcard', 'DISPID_SRCState', 'SRTEmulated',
    'DISPID_SGRSTWeight', 'DISPID_SRSCurrentStreamPosition',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechPhraseElement',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_MIN_TTS',
    'DISPID_SVEAudioLevel', 'SPFM_CREATE_ALWAYS',
    'SAFT48kHz8BitStereo', 'DISPID_SVEventInterests',
    'SPPS_RESERVED4', 'SPSHORTCUTTYPE', 'DISPID_SpeechPhraseBuilder',
    'SPEI_TTS_AUDIO_LEVEL', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPIDSPTSI', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechVoice', 'SpMemoryStream', 'DISPID_SOTsItem',
    ...
    'DISPID_SOTCreateInstance', 'DISPID_SOTId', 'ISpeechFileStream',
    'SRESoundEnd', 'DISPID_SPIGrammarId', 'DISPID_SRAudioInputStream'
]

_check_version('1.2.0', 1646297359.515303)
